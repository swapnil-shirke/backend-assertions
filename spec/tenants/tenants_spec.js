describe('Tenants --- ', function() {
	...
	describe('Get single tenant', function() {
		...
		it('should Get single tenant', function(done) {
	...
	describe('Create tenants', function() {
		...
		it('should Create tenants', function(done) {
	...
	describe('Update tenant', function() {
		...
		it('should update tenant', function(done) {
	...
	describe('Get all tenants', function() {
		...
		it('should get all tenant list', function(done) {
			factories.create('Create_tenants', authtoken, api_key, {
					"tenant": {
						"uid": "supertest",
						"name": "supertest",
	...
	describe('Delete tenant', function() {
		this.timeout(15000)
		it('should delete tenant', function(done) {
			factories.create('Create_tenants', authtoken, api_key)
				.expect(201)
				.end(function(err, res) {
